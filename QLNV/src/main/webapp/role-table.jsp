                                    ...
                                    <tbody>
                                    	...
                                    	<c:forEach items="${listRole}" var="r">
	                                        <tr>
	                                            ...
	                                            <td>${r.des}</td>
	                                            <td>
	                                                <a href="<c:url value="/role-edit?id=${r.id}"/>" class="btn btn-sm btn-primary">Sửa</a>
	                                                <a href="<c:url value="/role-delete?id=${r.id}"/>" class="btn btn-sm btn-danger">Xóa</a>
	                                            	<c:if test="${r.id==id&&not empty message}">${message}</c:if>
	                                            </td>
	                                        </tr>
                                        </c:forEach>
                                    </tbody>
